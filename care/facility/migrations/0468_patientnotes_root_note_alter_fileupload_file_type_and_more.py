# Generated by Django 5.1.1 on 2024-12-04 13:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='file_type',
            field=models.IntegerField(choices=[(0, 'OTHER'), (1, 'PATIENT'), (2, 'CONSULTATION'), (3, 'SAMPLE_MANAGEMENT'), (4, 'CLAIM'), (5, 'DISCHARGE_SUMMARY'), (6, 'COMMUNICATION'), (7, 'CONSENT_RECORD'), (8, 'ABDM_HEALTH_INFORMATION'), (9, 'PATIENT_NOTES')], default=1),
        ),
        migrations.AlterField(
